...
export default function Home() {
  ...
  return (
    <main style={{ padding: 32, fontFamily: 'sans-serif' }}>
      ...
      <br/>
      <span>1. 커스텀 확장자를 저장할 때, 이미 등록이 되어있는 커스텀 확장자면 '이미 존재하는 확장자입니다.'알림창 호출</span><br/>
      <span>2. 추가하는 확장자가 고정 확장자에 있는 확장자라면 커스텀 확장자로 저장되지 않고 해당 고정 확장자의 체크박스 체크</span><br/>
      <span>3. 20자 미만의 커스텀 확장자 다건 추가, 쉼표를 기준으로 분리해서 저장</span><br/>
      <span>4. 영문과 숫자만 입력 가능, 대문자 영문으로 추가시 소문자 영문으로 변환해서 저장</span><br/>
      <span>5. 커스텀 확장자 오름차순 정렬</span><br/>
      <span>6. 고정 확장자 전체 선택, 해제 체크박스</span><br/>
      <span>7. 저장된 전체 커스텀 확장자 삭제 버튼</span><br/>
      <span>8. 커스텀 확장자 입력창 초기화 버튼</span>
      </section>
    </main>
  );
}
